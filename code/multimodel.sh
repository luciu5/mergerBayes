...
# Args: [model_id] [chains] [threads] [use_cutoff] [use_hmt] [data_frac] [filter_year] [use_rho]
# Running for Year 2014 (High Variation) with 100% of data
srun Rscript ${HOME}/Projects/mergerBayes/code/bayesian.R ${SLURM_ARRAY_TASK_ID} $STAN_NUM_CHAINS $STAN_NUM_THREADS 0 0 1.0 2014-2015 0
EXIT_CODE=$?
