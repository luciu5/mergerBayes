...
We run our Bayesian Model Comparison on this single-market dataset, using Bridge Sampling to compute the marginal likelihoods. The results provide decisive evidence in favor of the **Cournot** model.
...
The Bayes Factor favoring Cournot over the next best alternative is substantial, suggesting that pre-merger competitive conduct in Philadelphia was best described by quantity-setting behavior (competition for a share of loanable funds) rather than pure price competition.
